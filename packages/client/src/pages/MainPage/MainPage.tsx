    ...
    <section className={styles.container}>
      ...
      <div className={styles.gameRules}>
        ...
        <p className={styles.rulesDescription}>
          Ваша задача — управляя Пакманом, съесть все начосы в лабиринте,
          избегая встречи с привидениями, которые бродят по карте.
          Зарегистрировавшись, вы сможете не только следить за своим рейтингом,
          но и за рейтингом других игроков, участвовать в форумах и создавать
          свои форумы на интересующие вас темы!
        </p>
      </div>
    </section>
  );
